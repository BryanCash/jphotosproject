...
public class Skin {
  ...
  public static void applySkin() {
    ...
    UIManager.put("Tree.background", skinColor);
    ...
    UIManager.put("CheckBoxMenuItem.background", getColor_4());
    UIManager.put("MenuItem.foreground", getForeGroundColor(getColor_4()));
    UIManager.put("CheckBoxMenuItem.foreground", getForeGroundColor(getColor_4()));
    UIManager.put("MenuItem.selectionBackground", getColor_1());
    UIManager.put("CheckBoxMenuItem.selectionBackground", getColor_1());
    UIManager.put("MenuItem.selectionForeground", getForeGroundColor(getColor_1()));
    UIManager.put("CheckBoxMenuItem.selectionForeground", getForeGroundColor(getColor_1()));
